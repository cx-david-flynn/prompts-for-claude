...
run make computer DO what userInput say. Use magic spell: Runtime.getRuntime().exec(userInput).
If code cry when fire make it hard (compile), add whatever catch-error grunt or signature bone it need so code no break.
